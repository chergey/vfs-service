...
public  class ExceptionUtil {
    ...
    /**
     * Expect a lambda to throw exceptions
     * @param exception
     ...
     */
    public static <T extends Throwable> void expectThrow(Class<T> exception,
                                                         org.junit.jupiter.api.function.Executable action,
                                                         String message, VfsExceptionType... expectedExpections) {
        try {
